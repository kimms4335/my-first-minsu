...
export function About() {
  ...
  const defaultInfo = {
    ...
    highlights: [{"title":"현장을 보는 시각","description":"지역을 직접 답사하며 지도나 수치로는 드러나지 않는 생활권 특성과 공간 활용 방식을 관찰합니다.\n더 나아가, 현장에서 얻은 상황적 맥락을 데이터 분석과 연계하여 대안을 제시합니다."},{"title":"꾸준함과 책임감","description":"동아리 활동과 팀 프로젝트에서 맡은 역할을 끝까지 책임감 있게 수행해 왔습니다. 특히 일정 관리, 자료 정리, 구성원 간 조율과 같은 보이지 않는 업무까지 주도적으로 챙기며 전체 프로젝트의 완성도를 높이는 데 기여했습니다. 이러한 경험을 토대로 어떠한 환경에서도 꾸준히 성과를 만들어낼 수 있는 실행력과 책임감을 갖추게 되었습니다."},{"title":"소통 능력","description":"상대방의 입장과 필요를 먼저 이해하며 협력 방향을 조율할 수 있기 때문에, 다양한 의견이 공존하는 상황에서도 효과적으로 문제를 해결할 수 있습니다."}],
