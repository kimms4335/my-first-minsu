...
export function About() {
  ...
  const defaultInfo = {
    ...
    skills: [{"title":"도시·부동산 리서치","level":"상","description":"","rating":90,"detail":"관련 사항 : 정책 자료·통계·실거래가 데이터를 활용한 프로젝트 진행 및 리포트 작성  경험 보유"},{"title":"소프트웨어 활용","level":"중","description":"","rating":95,"detail":"관련 사항 : ArcGIS 기반의 데이터 시각화 및 공간적 패턴 분석을 통해 지역 특성 및 변화 양상을 정밀하게 해석한 경험 보유"},{"title":"공간·현장 관찰","level":"상","description":"","rating":95,"detail":"관련 사항 : 도시재생·주거정책·상권 변화와 관련한 현장조사를 수행하며 관찰 기반의 분석 경험 축적"},{"title":"협업 & 커뮤니케이션","level":"상","description":"","detail":"관련 사항 : 교육봉사 동아리 임원으로서 프로그램 기획, 팀 프로젝트 과정에서 의견 조율과 협업을 통한 문제 해결 경험 보유","rating":98}],
