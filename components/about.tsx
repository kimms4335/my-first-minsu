...
export function About() {
  ...
  const defaultInfo = {
    ...
    skills: [{"title":"도시·부동산 리서치","level":"상","description":"정책 문헌과 통계 자료를 폭넓게 검토하여 흐름을 파악하고, 이를 토대로 핵심적인 시사점을 도출합니다."},{"title":"소프트웨어 활용","level":"중","description":"엑셀과 기본 통계를 활용하여 실거래가, 인구구조 등 데이터를 정리·시각화합니다."},{"title":"협업 & 커뮤니케이션","level":"상","description":"동아리 임원 경험을 바탕으로 일정 조율, 회의 진행, 역할 분담에 익숙합니다."}],
