...
export function About() {
  ...
  const defaultInfo = {
    ...
    projects: [{"title":"세운상가 프로젝트","period":"도시개발론","description":"세운상가의 문제점에 대해 조사한 뒤 구역별 재생 방안을 제시한 팀 프로젝트.","tags":["#세운상가","#도시재생","#현장조사"],"coverImage":"/uploads/project-cover-0-1763810731737.png","pdfName":"세운상가 리포트","pdfUrl":"https://naver.me/5asLLhzz"},{"title":"KFC 교대점과 양재점에 대한 상권 분석","period":"부동산입지","description":"KFC 교대점 및 양재점을 대상으로 상권·접근성·수요를 분석하여 입지 적합성을 평가한 팀 프로젝트.","tags":["#KFC","#교대점","#양재점","#입지","#상권분석"],"coverImage":"/uploads/project-cover-1-1763810633854.png","pdfName":"KFC 교대점 & 양재점 분석 리포트","pdfUrl":"https://naver.me/xI100N0A"},{"title":"서울 고덕아르테온 아파트 실거래가 분석","period":"토지론입문","description":"국토부 실거래가 데이터를 활용하여 고덕동 주요 단지의 가격 추세와 9호선 연장, 비즈밸리 조성 등 개발 호재의 영향을 분석한 리포트.","tags":["#실거래가","#아파트분석","#고덕아르테온"],"coverImage":"/uploads/project-cover-2-1763810806831.png","pdfName":"고덕아르테온 분석 리포트","pdfUrl":"https://naver.me/GScEabVD"},{"title":"일본 주택 문화 및 한·일 고령사회 주거정책 비교","period":"주택론입문","description":"한국과 일본의 고령자 주거지원, 빈집 문제, 농촌 활성화 정책을 비교하여 시사점을 정리한 팀 프로젝트.","tags":["#고령사회","#주거정책","#비교연구"],"coverImage":"/uploads/project-cover-3-1763810864438.png","pdfName":"일본 주택 문화와 주택 시장 리포트","pdfUrl":"https://naver.me/FhfJJryG"},{"title":"새 프로젝트","period":"2024","description":"프로젝트 설명을 입력하세요.","tags":["#프로젝트"],"coverImage":"","pdfName":"","pdfUrl":""},{"title":"새 프로젝트","period":"2024","description":"프로젝트 설명을 입력하세요.","tags":["#프로젝트"],"coverImage":"","pdfName":"","pdfUrl":""}],
